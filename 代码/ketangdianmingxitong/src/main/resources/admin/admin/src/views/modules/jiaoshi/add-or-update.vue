        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.jiaoshiPhoto" label="头像" prop="jiaoshiPhoto">
                        <file-upload
                            tip="点击上传头像"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.jiaoshiPhoto" label="头像" prop="jiaoshiPhoto">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="邮箱" prop="jiaoshiEmail">
                       <el-input v-model="ruleForm.jiaoshiEmail"
                                 placeholder="邮箱" clearable  :readonly="ro.jiaoshiEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="假删" prop="yonghuDelete">
                       <el-input v-model="ruleForm.yonghuDelete"
                                 placeholder="假删" clearable  :readonly="ro.yonghuDelete"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="假删" prop="yonghuDelete">
                           <el-input v-model="ruleForm.yonghuDelete"
                                     placeholder="假删" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            </el-row>
